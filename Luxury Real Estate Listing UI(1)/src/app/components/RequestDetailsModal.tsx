...
export function RequestDetailsModal({ isOpen, onClose }: RequestDetailsModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="font-['Montserrat'] text-sm text-white/60 mb-8">
              Complete the form below to receive a comprehensive property information package including floor plans, high-resolution photos, and full specifications.
            </p>
